...
#ifndef BBLPROFILER_CORE_H_
#define BBLPROFILER_CORE_H_

#include "core.h"
#include "pad.h"

class BbvProfiler : public Core {
    protected:
        uint64_t instrs;
        uint64_t bbls;
        uint64_t curCycle;
    ...
    protected:
        ...
        inline void bbl(BblInfo* bblInstrs, THREADID tid);
